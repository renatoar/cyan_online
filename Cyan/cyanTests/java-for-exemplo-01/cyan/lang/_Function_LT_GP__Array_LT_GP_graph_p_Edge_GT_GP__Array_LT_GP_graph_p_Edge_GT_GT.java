...
public class _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT extends _Any
 {

	private static final long serialVersionUID = 6616833015019243008L;
    static { 
        try {

          _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT.prototype = new _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT();
        }
...
"prototype"); 
    ...
    public     _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT() {

        } 

    public _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _new() {
         
            return new _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT();         
        } 

    public @Override _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _prototype() {
         return prototype;
        
        } 

    public _Array_LT_GP_graph_p_Edge_GT  _eval_1( _Array_LT_GP_graph_p_Edge_GT tmp743 ) {
        throw new ExceptionContainer__(new _ExceptionCannotCallAbstractMethod());
}

    public _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT  _curry_1( _Array_LT_GP_graph_p_Edge_GT _t1 )  {
        _Fun__0____ tmp744 = new _Fun__0____(this, _t1);

        return tmp744;
        } 

    public _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT  _verticalBar_greaterThan(_Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _f) {
        _Fun__1____ tmp745 = new _Fun__1____(this, _f);

        return tmp745;
        } 

    public _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Nil_GT _nilReturn() {
        _Fun__2____ tmp746 = new _Fun__2____(this);
        return tmp746;
        } 

    public @Override _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _clone() {
        
        try {
            return (_Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT ) this.clone(); 
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp747 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp747;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp748 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp749 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp749;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT prototype;
    ...
    static CyString []methodNameListFun_1__ = { 
        new CyString("eval: Array<graph.Edge>"),
        new CyString("clone"),
        new CyString("prototype")
        };
    ...
    static CyString []methodNameList = { 
        new CyString("prototype"),
        new CyString("eval: Array<graph.Edge>"),
        new CyString("curry: Array<graph.Edge>"),
    ...
    @SuppressWarnings( { "unused", "cast", "hiding" } )
private class _Fun__0____ extends cyan.lang._Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT
 {
	...
	private static final long serialVersionUID = 8886654447734910976L;
        ...
        private         cyan.lang._Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _self____;
        private         cyan.lang._Array_LT_GP_graph_p_Edge_GT _t1;
        public _Fun__0____() { }

        public         _Fun__0____(_Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _self____, _Array_LT_GP_graph_p_Edge_GT _t1)  {
        ...
        public _Fun__0____  _new_2( _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _self____, _Array_LT_GP_graph_p_Edge_GT _t1 )  {
             
            return new _Fun__0____(_self____, _t1);
        
            } 

        public @Override _Array_LT_GP_graph_p_Edge_GT _eval() {
            _Array_LT_GP_graph_p_Edge_GT tmp750 = _self____._eval_1( _t1);
    ...
    public String asString(int ident) {
        String s =  "Fun_0__ {\n";
        s = s + "super(cyan.lang.Function<Array<graph.Edge>>):"  + super.asStringThisOnly( ident + _Any.defaultIdentNumber__ );
    ...
    protected _Any parent() {
        return _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT.prototype;
    }
    ...
    @SuppressWarnings( { "unused", "cast", "hiding" } )
private class _Fun__1____ extends cyan.lang._Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT
 {
	...
	private static final long serialVersionUID = 279144571410163665L;
        ...
        private         cyan.lang._Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _self____;
        private         cyan.lang._Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _f;
        public _Fun__1____() { }

        public         _Fun__1____(_Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _self____, _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _f)  {
        ...
        public _Fun__1____  _new_2( _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _self____, _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _f )  {
             
            return new _Fun__1____(_self____, _f);
        
            } 

        public @Override _Array_LT_GP_graph_p_Edge_GT  _eval_1( _Array_LT_GP_graph_p_Edge_GT _elem )  {
            _Array_LT_GP_graph_p_Edge_GT tmp752 = _self____._eval_1( _elem);
            _Array_LT_GP_graph_p_Edge_GT tmp751 = _f._eval_1( tmp752);
    ...
    public String asString(int ident) {
        String s =  "Fun_1__ {\n";
        s = s + "super(cyan.lang.Function<Array<graph.Edge>,Array<graph.Edge>>):"  + super.asStringThisOnly( ident + _Any.defaultIdentNumber__ );
        s = s + asStringThisOnly( ident + _Any.defaultIdentNumber__);
    ...
    protected _Any parent() {
        return _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT.prototype;
    }
    protected CyString prototypePackage() {
        return new CyString( "cyan.lang" );
    }
    ...
    @SuppressWarnings( { "unused", "cast", "hiding" } )
private class _Fun__2____ extends cyan.lang._Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Nil_GT
 {
	...
	private static final long serialVersionUID = -573592701003332792L;
        ...
        public         _Fun__2____(_Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _self____)  {
        ...
        public _Fun__2____  _new_1( _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _self____ )  {
             
            return new _Fun__2____(_self____);
        
            } 

        public @Override _Nil  _eval_1( _Array_LT_GP_graph_p_Edge_GT _elem )  {
            _Array_LT_GP_graph_p_Edge_GT tmp753 = _self____._eval_1( _elem);
    ...
    public String asString(int ident) {
        String s =  "Fun_2__ {\n";
        s = s + "super(cyan.lang.Function<Array<graph.Edge>,Nil>):"  + super.asStringThisOnly( ident + _Any.defaultIdentNumber__ );
        s = s + asStringThisOnly( ident + _Any.defaultIdentNumber__);
    ...
    protected _Any parent() {
        return _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Nil_GT.prototype;
    }
    protected CyString prototypePackage() {
        return new CyString( "cyan.lang" );
    }
    ...
    public String asString(int ident) {
        String s =  "Function<Array<graph.Edge>,Array<graph.Edge>> {\n";
    ...
    static final String prototypeName = "Function<Array<graph.Edge>,Array<graph.Edge>>";
    @Override     public String getPrototypeName() { return prototypeName; }
    protected boolean isInterface() { return false; }
