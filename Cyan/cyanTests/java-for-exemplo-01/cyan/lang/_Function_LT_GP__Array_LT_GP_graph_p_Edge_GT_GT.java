...
public class _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT extends _Any
 {

	private static final long serialVersionUID = -2836259576495964376L;
    static { 
        try {

          _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT.prototype = new _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT();
        }
...
"prototype"); 
    ...
    public     _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT() {

        } 

    public @Override _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT _prototype() {
         return prototype;
        
        } 

    public _Array_LT_GP_graph_p_Edge_GT _eval(){
        throw new ExceptionContainer__(new _ExceptionCannotCallAbstractMethod());
}

    public _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT  _verticalBar_greaterThan(_Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _f) {
        _Fun__0____ tmp1011 = new _Fun__0____(this, _f);

        return tmp1011;
        } 

    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp1012 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp1012;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp1013 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp1014 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp1014;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT prototype;
...
private class _Fun__0____ extends cyan.lang._Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT
 {
	...
	private static final long serialVersionUID = 8886654447734910976L;
        ...
        private         cyan.lang._Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT _self____;
        private         cyan.lang._Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _f;
        public _Fun__0____() { }

        public         _Fun__0____(_Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT _self____, _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _f)  {
        ...
        public _Fun__0____  _new_2( _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GT _self____, _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Array_LT_GP_graph_p_Edge_GT_GT _f )  {
        ...
        public @Override _Array_LT_GP_graph_p_Edge_GT _eval() {
            _Array_LT_GP_graph_p_Edge_GT tmp1016 = _self____._eval();
            _Array_LT_GP_graph_p_Edge_GT tmp1015 = _f._eval_1( tmp1016);
    ...
    public String asString(int ident) {
        String s =  "Function<Array<graph.Edge>> {\n";
    ...
    static final String prototypeName = "Function<Array<graph.Edge>>";
    @Override     public String getPrototypeName() { return prototypeName; }
    protected boolean isInterface() { return false; }
