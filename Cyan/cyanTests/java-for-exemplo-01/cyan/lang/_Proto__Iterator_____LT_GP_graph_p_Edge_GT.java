...
public final class _Proto__Iterator_____LT_GP_graph_p_Edge_GT extends _Any
  implements  _Iterator_LT_GP_graph_p_Edge_GT {

	private static final long serialVersionUID = 3920406928442921472L;
    static { 
          _Proto__Iterator_____LT_GP_graph_p_Edge_GT.prototype = new _Proto__Iterator_____LT_GP_graph_p_Edge_GT(new NonExistingJavaClass());
          _Proto__Iterator_____LT_GP_graph_p_Edge_GT.prototype.initPrototype();
    }
    public _Proto__Iterator_____LT_GP_graph_p_Edge_GT(NonExistingJavaClass doNotExit) {
        super();
    }
    public void initPrototype() {
        
    }
    public _Proto__Iterator_____LT_GP_graph_p_Edge_GT() { }

    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp1064 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp1064;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp1065 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp1066 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp1066;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _Proto__Iterator_____LT_GP_graph_p_Edge_GT prototype;
    ...
    static final String prototypeName = "Iterator<graph.Edge>";
