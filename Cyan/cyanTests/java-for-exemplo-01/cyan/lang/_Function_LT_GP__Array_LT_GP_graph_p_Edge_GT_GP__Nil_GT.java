...
public class _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Nil_GT extends _Any
 {

	private static final long serialVersionUID = 7455985452232405617L;
    static { 
        try {

          _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Nil_GT.prototype = new _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Nil_GT();
        }
...
"prototype"); 
    ...
    public     _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Nil_GT() {

        } 

    public @Override _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Nil_GT _prototype() {
         return prototype;
        
        } 

    public _Nil  _eval_1( _Array_LT_GP_graph_p_Edge_GT tmp1017 ) {
        throw new ExceptionContainer__(new _ExceptionCannotCallAbstractMethod());
}

    public _Function_LT_GP__Nil_GT  _curry_1( _Array_LT_GP_graph_p_Edge_GT _t1 )  {
        _Fun__0____ tmp1018 = new _Fun__0____(this, _t1);

        return tmp1018;
        } 

    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp1019 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp1019;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp1020 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp1021 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp1021;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Nil_GT prototype;
...
private class _Fun__0____ extends cyan.lang._Function_LT_GP__Nil_GT
 {
	...
	private static final long serialVersionUID = 8886654447734910976L;
        ...
        private         cyan.lang._Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Nil_GT _self____;
        private         cyan.lang._Array_LT_GP_graph_p_Edge_GT _t1;
        public _Fun__0____() { }

        public         _Fun__0____(_Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Nil_GT _self____, _Array_LT_GP_graph_p_Edge_GT _t1)  {
        ...
        public _Fun__0____  _new_2( _Function_LT_GP__Array_LT_GP_graph_p_Edge_GT_GP__Nil_GT _self____, _Array_LT_GP_graph_p_Edge_GT _t1 )  {
        ...
        public @Override _Nil _eval() {
            _Nil tmp1022 = _self____._eval_1( _t1);
    ...
    public String asString(int ident) {
        String s =  "Function<Array<graph.Edge>,Nil> {\n";
    ...
    static final String prototypeName = "Function<Array<graph.Edge>,Nil>";
    @Override     public String getPrototypeName() { return prototypeName; }
    protected boolean isInterface() { return false; }
