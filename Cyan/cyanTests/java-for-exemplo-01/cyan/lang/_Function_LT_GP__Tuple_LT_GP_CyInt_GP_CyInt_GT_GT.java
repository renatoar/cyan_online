...
public class _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT extends _Any
 {

	private static final long serialVersionUID = -7332104415449015577L;
    static { 
        try {

          _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT.prototype = new _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT();
        }
...
"prototype"); 
    ...
    public     _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT() {

        } 

    public @Override _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _prototype() {
         return prototype;
        
        } 

    public _Tuple_LT_GP_CyInt_GP_CyInt_GT _eval(){
        throw new ExceptionContainer__(new _ExceptionCannotCallAbstractMethod());
}

    public _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT  _verticalBar_greaterThan(_Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _f) {
        _Fun__0____ tmp1023 = new _Fun__0____(this, _f);

        return tmp1023;
        } 

    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp1024 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp1024;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp1025 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp1026 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp1026;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT prototype;
    ...
    static CyString []methodNameList = { 
        new CyString("prototype"),
        new CyString("eval"),
        new CyString("|> Function<Tuple<Int,Int>,Tuple<Int,Int>>"),
    ...
    @SuppressWarnings( { "unused", "cast", "hiding" } )
private class _Fun__0____ extends cyan.lang._Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT
 {
	...
	private static final long serialVersionUID = 8886654447734910976L;
        ...
        private         cyan.lang._Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _self____;
        private         cyan.lang._Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _f;
        public _Fun__0____() { }

        public         _Fun__0____(_Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _self____, _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _f)  {
        ...
        public _Fun__0____  _new_2( _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _self____, _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _f )  {
             
            return new _Fun__0____(_self____, _f);
        
            } 

        public @Override _Tuple_LT_GP_CyInt_GP_CyInt_GT _eval() {
            _Tuple_LT_GP_CyInt_GP_CyInt_GT tmp1028 = _self____._eval();
            _Tuple_LT_GP_CyInt_GP_CyInt_GT tmp1027 = _f._eval_1( tmp1028);
    ...
    public String asString(int ident) {
        String s =  "Fun_0__ {\n";
        s = s + "super(cyan.lang.Function<Tuple<Int,Int>>):"  + super.asStringThisOnly( ident + _Any.defaultIdentNumber__ );
    ...
    protected _Any parent() {
        return _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT.prototype;
    }
    ...
    public String asString(int ident) {
        String s =  "Function<Tuple<Int,Int>> {\n";
    ...
    static final String prototypeName = "Function<Tuple<Int,Int>>";
    @Override     public String getPrototypeName() { return prototypeName; }
    protected boolean isInterface() { return false; }
