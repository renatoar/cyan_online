...
public class _Function_LT_GP_graph_p_Edge_GP_CyBoolean_GT extends _Any
 {

	private static final long serialVersionUID = -6148593137823885779L;
    static { 
        try {

          _Function_LT_GP_graph_p_Edge_GP_CyBoolean_GT.prototype = new _Function_LT_GP_graph_p_Edge_GP_CyBoolean_GT();
        }
...
"prototype"); 
    ...
    public     _Function_LT_GP_graph_p_Edge_GP_CyBoolean_GT() {

        } 

    public _Function_LT_GP_graph_p_Edge_GP_CyBoolean_GT _new() {
         
            return new _Function_LT_GP_graph_p_Edge_GP_CyBoolean_GT();         
        } 

    public @Override _Function_LT_GP_graph_p_Edge_GP_CyBoolean_GT _prototype() {
         return prototype;
        
        } 

    public CyBoolean  _eval_1( graph._Edge tmp726 ) {
        throw new ExceptionContainer__(new _ExceptionCannotCallAbstractMethod());
}

    public _Function_LT_GP_CyBoolean_GT  _curry_1( graph._Edge _t1 )  {
        _Fun__0____ tmp727 = new _Fun__0____(this, _t1);

        return tmp727;
        } 

    public @Override _Function_LT_GP_graph_p_Edge_GP_CyBoolean_GT _clone() {
        
        try {
            return (_Function_LT_GP_graph_p_Edge_GP_CyBoolean_GT ) this.clone(); 
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp728 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp728;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp729 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp730 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp730;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _Function_LT_GP_graph_p_Edge_GP_CyBoolean_GT prototype;
...
private class _Fun__0____ extends cyan.lang._Function_LT_GP_CyBoolean_GT
 {
	...
	private static final long serialVersionUID = 8886654447734910976L;
        ...
        private         cyan.lang._Function_LT_GP_graph_p_Edge_GP_CyBoolean_GT _self____;
        private         graph._Edge _t1;
        public _Fun__0____() { }

        public         _Fun__0____(_Function_LT_GP_graph_p_Edge_GP_CyBoolean_GT _self____, graph._Edge _t1)  {
        ...
        public _Fun__0____  _new_2( _Function_LT_GP_graph_p_Edge_GP_CyBoolean_GT _self____, graph._Edge _t1 )  {
        ...
        public @Override CyBoolean _eval() {
            CyBoolean tmp731 = _self____._eval_1( _t1);
    ...
    public String asString(int ident) {
        String s =  "Function<graph.Edge,Boolean> {\n";
    ...
    static final String prototypeName = "Function<graph.Edge,Boolean>";
    @Override     public String getPrototypeName() { return prototypeName; }
    protected boolean isInterface() { return false; }
