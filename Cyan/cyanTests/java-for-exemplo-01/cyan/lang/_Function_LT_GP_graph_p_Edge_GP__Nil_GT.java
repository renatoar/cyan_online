...
public class _Function_LT_GP_graph_p_Edge_GP__Nil_GT extends _Any
 {

	private static final long serialVersionUID = 1652334538201371967L;
    static { 
        try {

          _Function_LT_GP_graph_p_Edge_GP__Nil_GT.prototype = new _Function_LT_GP_graph_p_Edge_GP__Nil_GT();
        }
...
"prototype"); 
    ...
    public     _Function_LT_GP_graph_p_Edge_GP__Nil_GT() {

        } 

    public _Function_LT_GP_graph_p_Edge_GP__Nil_GT _new() {
         
            return new _Function_LT_GP_graph_p_Edge_GP__Nil_GT();         
        } 

    public @Override _Function_LT_GP_graph_p_Edge_GP__Nil_GT _prototype() {
         return prototype;
        
        } 

    public _Nil  _eval_1( graph._Edge tmp720 ) {
        throw new ExceptionContainer__(new _ExceptionCannotCallAbstractMethod());
}

    public _Function_LT_GP__Nil_GT  _curry_1( graph._Edge _t1 )  {
        _Fun__0____ tmp721 = new _Fun__0____(this, _t1);

        return tmp721;
        } 

    public @Override _Function_LT_GP_graph_p_Edge_GP__Nil_GT _clone() {
        
        try {
            return (_Function_LT_GP_graph_p_Edge_GP__Nil_GT ) this.clone(); 
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp722 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp722;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp723 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp724 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp724;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _Function_LT_GP_graph_p_Edge_GP__Nil_GT prototype;
...
private class _Fun__0____ extends cyan.lang._Function_LT_GP__Nil_GT
 {
	...
	private static final long serialVersionUID = 8886654447734910976L;
        ...
        private         cyan.lang._Function_LT_GP_graph_p_Edge_GP__Nil_GT _self____;
        private         graph._Edge _t1;
        public _Fun__0____() { }

        public         _Fun__0____(_Function_LT_GP_graph_p_Edge_GP__Nil_GT _self____, graph._Edge _t1)  {
        ...
        public _Fun__0____  _new_2( _Function_LT_GP_graph_p_Edge_GP__Nil_GT _self____, graph._Edge _t1 )  {
        ...
        public @Override _Nil _eval() {
            _Nil tmp725 = _self____._eval_1( _t1);
    ...
    public String asString(int ident) {
        String s =  "Function<graph.Edge,Nil> {\n";
    ...
    static final String prototypeName = "Function<graph.Edge,Nil>";
    @Override     public String getPrototypeName() { return prototypeName; }
    protected boolean isInterface() { return false; }
