...
public final class _Proto__Iterable_____LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT extends _Any
  implements  _Iterable_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT {

	private static final long serialVersionUID = 3149179766484935395L;
    static { 
          _Proto__Iterable_____LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT.prototype = new _Proto__Iterable_____LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT(new NonExistingJavaClass());
          _Proto__Iterable_____LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT.prototype.initPrototype();
    }
    public _Proto__Iterable_____LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT(NonExistingJavaClass doNotExit) {
        super();
    }
    public void initPrototype() {
        
    }
    public _Proto__Iterable_____LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT() { }

    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp1067 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp1067;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp1068 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp1069 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp1069;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _Proto__Iterable_____LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT prototype;
    ...
    public String asString(int ident) {
        String s =  "Iterable<Tuple<Int,Int>> {\n";
    ...
    static final String prototypeName = "Iterable<Tuple<Int,Int>>";
    @Override     public String getPrototypeName() { return prototypeName; }
    protected boolean isInterface() { return true; }
