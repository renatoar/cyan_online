...
public class _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT extends _Any
 {

	private static final long serialVersionUID = -8873650800758772416L;
    static { 
        try {

          _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT.prototype = new _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT();
        }
...
"prototype"); 
    ...
    public     _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT() {

        } 

    public _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT _new() {
         
            return new _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT();         
        } 

    public @Override _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT _prototype() {
         return prototype;
        
        } 

    public graph._Edge  _eval_1( graph._Edge tmp732 ) {
        throw new ExceptionContainer__(new _ExceptionCannotCallAbstractMethod());
}

    public _Function_LT_GP_graph_p_Edge_GT  _curry_1( graph._Edge _t1 )  {
        _Fun__0____ tmp733 = new _Fun__0____(this, _t1);

        return tmp733;
        } 

    public _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT  _verticalBar_greaterThan(_Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT _f) {
        _Fun__1____ tmp734 = new _Fun__1____(this, _f);

        return tmp734;
        } 

    public _Function_LT_GP_graph_p_Edge_GP__Nil_GT _nilReturn() {
        _Fun__2____ tmp735 = new _Fun__2____(this);
        return tmp735;
        } 

    public @Override _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT _clone() {
        
        try {
            return (_Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT ) this.clone(); 
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp736 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp736;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp737 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp738 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp738;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT prototype;
...
private class _Fun__0____ extends cyan.lang._Function_LT_GP_graph_p_Edge_GT
 {
	...
	private static final long serialVersionUID = 8886654447734910976L;
        ...
        private         cyan.lang._Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT _self____;
        private         graph._Edge _t1;
        public _Fun__0____() { }

        public         _Fun__0____(_Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT _self____, graph._Edge _t1)  {
        ...
        public _Fun__0____  _new_2( _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT _self____, graph._Edge _t1 )  {
        ...
        public @Override graph._Edge _eval() {
            graph._Edge tmp739 = _self____._eval_1( _t1);
    ...
    @SuppressWarnings( { "unused", "cast", "hiding" } )
private class _Fun__1____ extends cyan.lang._Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT
 {
	...
	private static final long serialVersionUID = 279144571410163665L;
        ...
        public         _Fun__1____(_Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT _self____, _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT _f)  {
        ...
        public _Fun__1____  _new_2( _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT _self____, _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT _f )  {
             
            return new _Fun__1____(_self____, _f);
        
            } 

        public @Override graph._Edge  _eval_1( graph._Edge _elem )  {
            graph._Edge tmp741 = _self____._eval_1( _elem);
            graph._Edge tmp740 = _f._eval_1( tmp741);
    ...
    public String asString(int ident) {
        String s =  "Fun_1__ {\n";
        s = s + "super(cyan.lang.Function<graph.Edge,graph.Edge>):"  + super.asStringThisOnly( ident + _Any.defaultIdentNumber__ );
        s = s + asStringThisOnly( ident + _Any.defaultIdentNumber__);
    ...
    protected _Any parent() {
        return _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT.prototype;
    }
    protected CyString prototypePackage() {
        return new CyString( "cyan.lang" );
    }
    ...
    @SuppressWarnings( { "unused", "cast", "hiding" } )
private class _Fun__2____ extends cyan.lang._Function_LT_GP_graph_p_Edge_GP__Nil_GT
 {
	...
	private static final long serialVersionUID = -573592701003332792L;
        ...
        public         _Fun__2____(_Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT _self____)  {
        ...
        public _Fun__2____  _new_1( _Function_LT_GP_graph_p_Edge_GP_graph_p_Edge_GT _self____ )  {
        ...
        public @Override _Nil  _eval_1( graph._Edge _elem )  {
            graph._Edge tmp742 = _self____._eval_1( _elem);
    ...
    public String asString(int ident) {
        String s =  "Function<graph.Edge,graph.Edge> {\n";
    ...
    static final String prototypeName = "Function<graph.Edge,graph.Edge>";
    @Override     public String getPrototypeName() { return prototypeName; }
    protected boolean isInterface() { return false; }
