...
public class _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 extends _Any
 {

	private static final long serialVersionUID = 907091652430696448L;
    static { 
        try {

          _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115.prototype = new _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115();
        }
...
"prototype"); 
    ...
    public     _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115() {

        } 

    public _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _new() {
         
            return new _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115();         
        } 

    public @Override _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _prototype() {
         return prototype;
        
        } 

    public _Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT  _eval_1( _Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT tmp960 ) {
        throw new ExceptionContainer__(new _ExceptionCannotCallAbstractMethod());
}

    public _Function_LT_GP__Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT_GT  _curry_1( _Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _t1 )  {
        _Fun__0____ tmp961 = new _Fun__0____(this, _t1);

        return tmp961;
        } 

    public _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115  _verticalBar_greaterThan(_Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _f) {
        _Fun__1____ tmp962 = new _Fun__1____(this, _f);

        return tmp962;
        } 

    public _Function_LT_GP__Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT_GP__Nil_GT _nilReturn() {
        _Fun__2____ tmp963 = new _Fun__2____(this);
        return tmp963;
        } 

    public @Override _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _clone() {
        
        try {
            return (_Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 ) this.clone(); 
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp964 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp964;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp965 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp966 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp966;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 prototype;
    ...
    static CyString []methodNameListFun_1__ = { 
        new CyString("eval: Array<Tuple<Int,Int>>"),
        new CyString("clone"),
        new CyString("prototype")
        };
    ...
    @SuppressWarnings( { "unused", "cast", "hiding" } )
private class _Fun__0____ extends cyan.lang._Function_LT_GP__Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT_GT
 {
	...
	private static final long serialVersionUID = 8886654447734910976L;
        ...
        private         cyan.lang._Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _self____;
        private         cyan.lang._Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _t1;
        public _Fun__0____() { }

        public         _Fun__0____(_Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _self____, _Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _t1)  {
        ...
        public _Fun__0____  _new_2( _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _self____, _Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _t1 )  {
             
            return new _Fun__0____(_self____, _t1);
        
            } 

        public @Override _Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _eval() {
            _Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT tmp967 = _self____._eval_1( _t1);
    ...
    public String asString(int ident) {
        String s =  "Fun_0__ {\n";
        s = s + "super(cyan.lang.Function<Array<Tuple<Int,Int>>>):"  + super.asStringThisOnly( ident + _Any.defaultIdentNumber__ );
    ...
    protected _Any parent() {
        return _Function_LT_GP__Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT_GT.prototype;
    }
    ...
    @SuppressWarnings( { "unused", "cast", "hiding" } )
private class _Fun__1____ extends cyan.lang._Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115
 {
	...
	private static final long serialVersionUID = 279144571410163665L;
        ...
        private         cyan.lang._Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _self____;
        private         cyan.lang._Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _f;
        public _Fun__1____() { }

        public         _Fun__1____(_Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _self____, _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _f)  {
        ...
        public _Fun__1____  _new_2( _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _self____, _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _f )  {
             
            return new _Fun__1____(_self____, _f);
        
            } 

        public @Override _Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT  _eval_1( _Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _elem )  {
            _Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT tmp969 = _self____._eval_1( _elem);
            _Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT tmp968 = _f._eval_1( tmp969);
    ...
    public String asString(int ident) {
        String s =  "Fun_1__ {\n";
        s = s + "super(cyan.lang.Function<Array<Tuple<Int,Int>>,Array<Tuple<Int,Int>>>):"  + super.asStringThisOnly( ident + _Any.defaultIdentNumber__ );
        s = s + asStringThisOnly( ident + _Any.defaultIdentNumber__);
    ...
    protected _Any parent() {
        return _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115.prototype;
    }
    protected CyString prototypePackage() {
        return new CyString( "cyan.lang" );
    }
    ...
    @SuppressWarnings( { "unused", "cast", "hiding" } )
private class _Fun__2____ extends cyan.lang._Function_LT_GP__Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT_GP__Nil_GT
 {
	...
	private static final long serialVersionUID = -573592701003332792L;
        ...
        public         _Fun__2____(_Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _self____)  {
        ...
        public _Fun__2____  _new_1( _Function_LT_GP__Array_LT_GP__Tuple_LT_G_1922597558182182915_115 _self____ )  {
             
            return new _Fun__2____(_self____);
        
            } 

        public @Override _Nil  _eval_1( _Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT _elem )  {
            _Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT tmp970 = _self____._eval_1( _elem);
    ...
    public String asString(int ident) {
        String s =  "Fun_2__ {\n";
        s = s + "super(cyan.lang.Function<Array<Tuple<Int,Int>>,Nil>):"  + super.asStringThisOnly( ident + _Any.defaultIdentNumber__ );
        s = s + asStringThisOnly( ident + _Any.defaultIdentNumber__);
    ...
    protected _Any parent() {
        return _Function_LT_GP__Array_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GT_GP__Nil_GT.prototype;
    }
    protected CyString prototypePackage() {
        return new CyString( "cyan.lang" );
    }
    ...
    public String asString(int ident) {
        String s =  "Function<Array<Tuple<Int,Int>>,Array<Tuple<Int,Int>>> {\n";
    ...
    static final String prototypeName = "Function<Array<Tuple<Int,Int>>,Array<Tuple<Int,Int>>>";
    @Override     public String getPrototypeName() { return prototypeName; }
    protected boolean isInterface() { return false; }
