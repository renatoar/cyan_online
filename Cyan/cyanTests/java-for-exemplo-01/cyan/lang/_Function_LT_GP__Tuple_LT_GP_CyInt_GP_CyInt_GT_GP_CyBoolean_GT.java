...
public class _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP_CyBoolean_GT extends _Any
 {

	private static final long serialVersionUID = -822277560228726184L;
    static { 
        try {

          _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP_CyBoolean_GT.prototype = new _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP_CyBoolean_GT();
        }
...
"prototype"); 
    ...
    public     _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP_CyBoolean_GT() {

        } 

    public _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP_CyBoolean_GT _new() {
         
            return new _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP_CyBoolean_GT();         
        } 

    public @Override _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP_CyBoolean_GT _prototype() {
         return prototype;
        
        } 

    public CyBoolean  _eval_1( _Tuple_LT_GP_CyInt_GP_CyInt_GT tmp943 ) {
        throw new ExceptionContainer__(new _ExceptionCannotCallAbstractMethod());
}

    public _Function_LT_GP_CyBoolean_GT  _curry_1( _Tuple_LT_GP_CyInt_GP_CyInt_GT _t1 )  {
        _Fun__0____ tmp944 = new _Fun__0____(this, _t1);

        return tmp944;
        } 

    public @Override _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP_CyBoolean_GT _clone() {
        
        try {
            return (_Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP_CyBoolean_GT ) this.clone(); 
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp945 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp945;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp946 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp947 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp947;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP_CyBoolean_GT prototype;
    ...
    static CyString []methodNameList = { 
        ...
        new CyString("curry: Tuple<Int,Int>"),
        new CyString("clone"),
    ...
    @SuppressWarnings( { "unused", "cast", "hiding" } )
private class _Fun__0____ extends cyan.lang._Function_LT_GP_CyBoolean_GT
 {
	...
	private static final long serialVersionUID = 8886654447734910976L;
        ...
        private         cyan.lang._Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP_CyBoolean_GT _self____;
        private         cyan.lang._Tuple_LT_GP_CyInt_GP_CyInt_GT _t1;
        public _Fun__0____() { }

        public         _Fun__0____(_Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP_CyBoolean_GT _self____, _Tuple_LT_GP_CyInt_GP_CyInt_GT _t1)  {
        ...
        public _Fun__0____  _new_2( _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP_CyBoolean_GT _self____, _Tuple_LT_GP_CyInt_GP_CyInt_GT _t1 )  {
             
            return new _Fun__0____(_self____, _t1);
        
            } 

        public @Override CyBoolean _eval() {
            CyBoolean tmp948 = _self____._eval_1( _t1);
    ...
    public String asString(int ident) {
        String s =  "Fun_0__ {\n";
        s = s + "super(cyan.lang.Function<Boolean>):"  + super.asStringThisOnly( ident + _Any.defaultIdentNumber__ );
    ...
    protected _Any parent() {
        return _Function_LT_GP_CyBoolean_GT.prototype;
    }
    ...
    public String asString(int ident) {
        String s =  "Function<Tuple<Int,Int>,Boolean> {\n";
    ...
    static final String prototypeName = "Function<Tuple<Int,Int>,Boolean>";
    @Override     public String getPrototypeName() { return prototypeName; }
    protected boolean isInterface() { return false; }
