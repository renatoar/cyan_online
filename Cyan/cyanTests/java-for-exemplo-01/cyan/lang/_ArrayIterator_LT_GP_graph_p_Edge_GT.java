...
public class _ArrayIterator_LT_GP_graph_p_Edge_GT extends _Any
  implements  _Iterator_LT_GP_graph_p_Edge_GT {

	private static final long serialVersionUID = -1460495636517087351L;
    static { 
          _ArrayIterator_LT_GP_graph_p_Edge_GT.prototype = new _ArrayIterator_LT_GP_graph_p_Edge_GT(new NonExistingJavaClass());
          _ArrayIterator_LT_GP_graph_p_Edge_GT.prototype.initPrototype();
    }
    public _ArrayIterator_LT_GP_graph_p_Edge_GT(NonExistingJavaClass doNotExit) {
        super();
    }
    public void initPrototype() {
        this._s = _Array_LT_GP_graph_p_Edge_GT.prototype;this._index = CyInt.zero;
    }
    private     cyan.lang._Array_LT_GP_graph_p_Edge_GT _s;
    private     cyan.lang.CyInt _index;
    public _ArrayIterator_LT_GP_graph_p_Edge_GT() { }

    public     _ArrayIterator_LT_GP_graph_p_Edge_GT(_Array_LT_GP_graph_p_Edge_GT _s)  {
    ...
    public _ArrayIterator_LT_GP_graph_p_Edge_GT  _new_1( _Array_LT_GP_graph_p_Edge_GT _p0 )  {
         
            return new _ArrayIterator_LT_GP_graph_p_Edge_GT(_p0);
        
        } 

    public @Override CyBoolean _hasNext() {
        CyInt tmp1042 = _s._size();
        CyBoolean tmp1041 = _index._lessThan( tmp1042);

        return tmp1041;
        } 

    public @Override graph._Edge _next() {
        CyInt tmp1044 = _s._size();
        CyBoolean tmp1043 = _index._lessThan( tmp1044);
        if ( tmp1043.b ) {
            _index = _index._succ();
            graph._Edge tmp1045;
            CyInt tmp1046 = _index._minus( CyInt.one);
            tmp1045 = _s._at_1(tmp1046);

            return tmp1045;
        }
        else {
            Object tmp1047 = this._throw_1( _ExceptionIterator.prototype);
            return null;
        }
        // end of if
        } 

    public @Override _ArrayIterator_LT_GP_graph_p_Edge_GT _prototype() {
         return prototype;
        
        } 

    public @Override _ArrayIterator_LT_GP_graph_p_Edge_GT _clone() {
        
        try {
            return (_ArrayIterator_LT_GP_graph_p_Edge_GT ) this.clone(); 
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp1048 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp1048;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp1049 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp1050 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp1050;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _ArrayIterator_LT_GP_graph_p_Edge_GT prototype;

    static final String []fieldList = { "s", "index" };
    static final String []fieldTypeList = { "cyan.lang.Array<graph.Edge>", "cyan.lang.Int" };
    ...
    public String asString(int ident) {
        String s =  "ArrayIterator<graph.Edge> {\n";
    ...
    static final String prototypeName = "ArrayIterator<graph.Edge>";
