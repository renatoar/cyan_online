...
public class _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Nil_GT extends _Any
 {

	private static final long serialVersionUID = -4976767916335066440L;
    static { 
        try {

          _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Nil_GT.prototype = new _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Nil_GT();
        }
...
"prototype"); 
    ...
    public     _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Nil_GT() {

        } 

    public _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Nil_GT _new() {
         
            return new _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Nil_GT();         
        } 

    public @Override _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Nil_GT _prototype() {
         return prototype;
        
        } 

    public _Nil  _eval_1( _Tuple_LT_GP_CyInt_GP_CyInt_GT tmp937 ) {
        throw new ExceptionContainer__(new _ExceptionCannotCallAbstractMethod());
}

    public _Function_LT_GP__Nil_GT  _curry_1( _Tuple_LT_GP_CyInt_GP_CyInt_GT _t1 )  {
        _Fun__0____ tmp938 = new _Fun__0____(this, _t1);

        return tmp938;
        } 

    public @Override _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Nil_GT _clone() {
        
        try {
            return (_Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Nil_GT ) this.clone(); 
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp939 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp939;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp940 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp941 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp941;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Nil_GT prototype;
...
private class _Fun__0____ extends cyan.lang._Function_LT_GP__Nil_GT
 {
	...
	private static final long serialVersionUID = 8886654447734910976L;
        ...
        private         cyan.lang._Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Nil_GT _self____;
        private         cyan.lang._Tuple_LT_GP_CyInt_GP_CyInt_GT _t1;
        public _Fun__0____() { }

        public         _Fun__0____(_Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Nil_GT _self____, _Tuple_LT_GP_CyInt_GP_CyInt_GT _t1)  {
        ...
        public _Fun__0____  _new_2( _Function_LT_GP__Tuple_LT_GP_CyInt_GP_CyInt_GT_GP__Nil_GT _self____, _Tuple_LT_GP_CyInt_GP_CyInt_GT _t1 )  {
        ...
        public @Override _Nil _eval() {
            _Nil tmp942 = _self____._eval_1( _t1);
    ...
    public String asString(int ident) {
        String s =  "Function<Tuple<Int,Int>,Nil> {\n";
    ...
    static final String prototypeName = "Function<Tuple<Int,Int>,Nil>";
    @Override     public String getPrototypeName() { return prototypeName; }
    protected boolean isInterface() { return false; }
