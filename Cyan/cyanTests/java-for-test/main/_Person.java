...
public final class _Person extends _Any
 {

	private static final long serialVersionUID = 4397587055346726720L;
    static { 
        try {

          _Person.prototype = new _Person();
        }
...
"prototype"); 
    ...
    private     cyan.lang.CyString _name;

    public     _Person() {

    this._name = (new CyString(""));

        } 

    public main._Person _new() {
         
            return new _Person();        
        } 

    public CyString _getName() {

        return _name;
        } 

    public _Nil  _setName_1( CyString _name )  {
        /* self.name = name */
        this._name = _name;
        return _Nil.prototype;
        } 

    public @Override main._Person _prototype() {
         return prototype;
        
        } 

    public @Override main._Person _clone() {
        
        try {
            return (_Person ) this.clone(); 
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp398 = new _Array_LT_GP__Tuple_LT_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();

        return tmp398;
        } 

    public @Override _Array_LT_GP__Any_GT _getAnnotListNameDoesNotCollide____() {
        _Array_LT_GP__Any_GT tmp399 = new _Array_LT_GP__Any_GT();
    ...
    public @Override _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT _getSlotFeatureListNameDoesNotCollide____() {
        _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT tmp400 = new _Array_LT_GP__Tuple_LT_GP__slotName_GP_CyString_GP__key_GP_CyString_GP__value_GP__Any_GT_GT();
        ...
        _slotFeatureList__name__does__not__collide____ = tmp400;

        return _slotFeatureList__name__does__not__collide____;
        } 
    public static _Person prototype;

    static final String []fieldList = { "name" };
    static final String []fieldTypeList = { "cyan.lang.String" };
    ...
    static CyString []methodNameList = { 
        new CyString("getName"),
        new CyString("setName: String"),
    ...
    protected String asStringThisOnly(int ident) {
        ...
        s = s + getWhiteSpaces(ident) + "name: " + _name._asString().s + "\n";
        return s;
    } 
    ...
    static final String prototypeName = "Person";
