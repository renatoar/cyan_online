 ...
 *
 */
public class CodegCommandGUI extends javax.swing.JDialog {
	...
	public CodegCommandGUI(java.awt.Frame parent, byte[] previousUserInput, String previousLabel) {
		super(parent, true);
		...
		txtRun.setText(new String(userInput));
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										layout.createSequentialGroup().addComponent(txtRun)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
	...
	private void btSearchDirectoryActionPerformed(java.awt.event.ActionEvent evt) {
		...
		chooser.setDialogTitle("Select Default Folder");
	...
	private void btOkActionPerformed(java.awt.event.ActionEvent evt) {
		...
		String start = "start";
		if (txtRun.getText() != "")
			start = "start cd /d " + txtRun.getText();
		try {
			rt.exec(new String[] { "cmd.exe", "/K", start });
		} catch (Exception e) {
		}
		userInput = txtRun.getText().getBytes();
