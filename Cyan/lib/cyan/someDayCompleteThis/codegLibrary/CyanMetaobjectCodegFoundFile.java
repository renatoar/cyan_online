...
public class CyanMetaobjectCodegFoundFile extends CyanMetaobjectWithAtCodeg implements ICodeg, IAction_dsa {
	...
	public CyanMetaobjectCodegFoundFile() {
		super("foundFile", AnnotationArgumentsKind.OneParameter);
	}
	...
	public byte[] getUserInput(ICompiler_ded compiler_ded, byte[] previousCodegFileText) {
		...
		CodegFoundFileGUI codegGUI = new CodegFoundFileGUI(new Frame(), previousCodegFileText, firstParameter);
